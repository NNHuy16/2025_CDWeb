    ...
    <div className="fixed inset-0 backdrop-blur-sm bg-white/30 flex items-center justify-center z-50">
      <div className="bg-white w-full max-w-md rounded-xl shadow-lg p-6 relative">
        ...
        <div className="text-center mb-4">
          ...
          <h2 className="text-xl font-semibold mt-2">Đăng Ký</h2>
          <p className="text-sm mt-1 text-gray-600">Chào mừng bạn đã đến với chúng tôi 👋🏻</p>
        </div>
        ...
        <div className="text-center mt-4">
          <p className="text-sm">
            Bạn đã có tài khoản? <Link to="/register" className="text-orange-500 font-medium">Đăng nhập ngay</Link>
          </p>
